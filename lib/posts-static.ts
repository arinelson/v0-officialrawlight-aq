  ...
  pt: [
    {
      ...
      readingTime: 12,
      content: `# Por Que Árabes e Judeus Brigam Até Hoje?
...
Para lidar com situações como essa, existiam leis antigas documentadas em textos como as Tábuas de Nuzi, Eshnunna e Alalakh. Essas leis regulamentavam práticas sociais e familiares, incluindo soluções para casais sem filhos. Se uma mulher não podia conceber, o marido poderia ter um filho com uma serva ou escrava da casa, desde que a esposa concordasse. Esse filho seria legalmente reconhecido como filho da esposa, funcionando quase como uma "barriga de aluguel" moderna. Embora fosse uma prática aceita e culturalmente válida, ela carregava implicações emocionais e sociais complexas.
